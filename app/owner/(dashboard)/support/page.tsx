...
export default async function OwnerSupportPage() {
  ...
  return (
    <>
      {/* This page had NO header at all, so on a phone it rendered with zero
          navigation chrome — no title bar, no back. */}
      <AppHeader title="Support" showBack notificationsHref="/owner/notifications" />
