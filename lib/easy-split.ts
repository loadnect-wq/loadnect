...
//
// MONEY FLOW (model: lib/booking-payment.ts — standard commission absorbed + platform fee)
//   customer pays advance + platform fee → funds sit in Hallnect's
//                            Cashfree account, unsplit
//   owner ACCEPTS          → payOwnerOnAcceptance() assigns the owner's NET
//                            ADVANCE (advance − commission, fee excluded)
