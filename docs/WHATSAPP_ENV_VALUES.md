...
# --- PENDING META APPROVAL - DO NOT SET THESE YET -------------------------
# Twilio refuses to send a template Meta has not approved, so setting a SID
# early turns every affected notification into a hard failure. While they are
# unset, resolveTemplate falls back to the templates they supersede, which are
# approved and send. Set each one only after its status reads Approved in the
# Content Template Builder, then redeploy (Vercel bakes env at build time).
#   Submitted 2026-08-29, all three category Utility.
# TWILIO_TEMPLATE_OWNER_HALL_LIVE=HX1098eddcc8890b3897d77503124a6366
# TWILIO_TEMPLATE_OWNER_ACCOUNT_STATUS=HXf38231b3fe8740f63e4f0e37921aeec1
# TWILIO_TEMPLATE_OWNER_PAYMENT_RECEIPT=HX7fe00c6f60fabe9c9644d3deaf0770b1
