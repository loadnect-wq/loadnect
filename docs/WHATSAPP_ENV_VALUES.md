...
# Utility replacements for the two templates Meta had approved as Marketing.
# Submitted 2026-08-29, APPROVED 2026-08-30, set in Vercel the same day.
# Typed Config (not Sensitive) on purpose: a Content SID is not a credential,
# and Config values can be read back.
